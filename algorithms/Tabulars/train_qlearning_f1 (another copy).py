...
def train_qlearning_f1(config):
    ...
    for episode in range(total_episodes):
        ...
        if not episode % config['save_episodes']:
            ...
            print(f"\nSaving STATS of model every {config['save_episodes']} episodes . . .\n")
    ...
    print(f"Start Time: {start_time}, ent time: {end_time_training}, and exec time: {training_time} in seconds")
