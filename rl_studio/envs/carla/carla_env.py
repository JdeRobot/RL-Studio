    ...
    def CFCCCSF__init__(self, **config):
        ...
        if ps_output.count("gzclient") > 0:
            try:
                ...
                logger.error(
                    "SimulatorEnv: exception raised executing killall command for gzclient {}".format(
                        ce
                    )
                )
        ...
        if ps_output.count("gzserver") > 0:
            try:
                ...
                logger.error(
                    "SimulatorEnv: exception raised executing killall command for gzserver {}".format(
                        ce
                    )
                )
        ...
        if ps_output.count("rosout") > 0:
            try:
                ...
                logger.error(
                    "SimulatorEnv: exception raised executing killall command for rosout {}".format(
                        ce
                    )
                )
        ...
        if ps_output.count("bridge.py") > 0:
            try:
                os.system(
                    "ps -ef | grep 'bridge.py' | awk '{print $2}' | xargs kill -9"
                )
                logger.debug("SimulatorEnv:bridge.py killed.")
            except subprocess.CalledProcessError as ce:
                logger.error(
                    "SimulatorEnv: exception raised executing killall command for bridge.py {}".format(
                        ce
                    )
                )
        ...
        if ps_output.count("rosmaster") > 0:
            try:
                ...
                logger.error(
                    "SimulatorEnv: exception raised executing killall command for rosmaster {}".format(
                        ce
                    )
                )
        ...
        if ps_output.count("roscore") > 0:
            try:
                ...
                logger.error(
                    "SimulatorEnv: exception raised executing killall command for roscore {}".format(
                        ce
                    )
                )
        ...
        if ps_output.count("px4") > 0:
            try:
                ...
                logger.error(
                    "SimulatorEnv: exception raised executing killall command for px4 {}".format(
                        ce
                    )
                )
        ...
        if ps_output.count("roslaunch") > 0:
            try:
                ...
                logger.error(
                    "SimulatorEnv: exception raised executing killall command for roslaunch {}".format(
                        ce
                    )
                )
        ...
        try:
            ...
            logger.error(
                "CarlaEnv: exception raised searching CARLA_ROOT env variable. {}".format(
                    oe
                )
            )
        ...
        try:
            ...
            logger.info("CarlaEnv: launching simulator server.")
            time.sleep(5)
