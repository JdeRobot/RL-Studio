    ...
    def save_bev_image(self, image):
        ...
        if self.display_man.render_enabled():
            ...
            if image.shape[0] != image.shape[1]:
                ...
                image = np.pad(image, ((extra_top, extra_bottom), (extra_left, extra_right), (0, 0)), mode='constant', constant_values=0)
                image = np.pad(image, ((100, 100), (50, 50), (0, 0)), mode='constant', constant_values=0)
