...
class World(object):
    ...
    def restart(self, args):
        ...
        ###################################
        # TODO: here we mark init position
        ...
        if self.player is not None:
            ...
            self.destroy()
            self.player = self.world.spawn_actor(blueprint, location)
...
class HUD(object):
    ...
    def __init__(self, width, height):
        ...
        # TODO: init pose
        self.x_prev, self.y_prev, self.z_prev = 73.7, -10, 0.3
        self.dist = 0
    ...
    def tick(self, world, clock):
        ...
        # print(f"{self.x_prev=}, {self.y_prev=}, {self.z_prev=}")
        x_act, y_act, z_act = (
            transform.location.x,
            transform.location.y,
            transform.location.z,
        )
        # print(f"{x_act=}, {y_act=}, {z_act=}")
        self.dist += math.sqrt(
            (x_act - self.x_prev) ** 2
            + (y_act - self.y_prev) ** 2
            + (z_act - self.z_prev) ** 2
        ...
        # print(f"{self.dist =}")
        self.x_prev, self.y_prev, self.z_prev = x_act, y_act, z_act
...
def game_loop(args):
    ...
    try:
        ...
        # TODO: load town
        sim_world = client.load_world("Town07")
        ...
        # TODO: target destination in x, y, z coordinates
        destination.x = 23.7  # 19.8
        destination.y = -236.2  # -239
        destination.z = 0.5  # -239
        ...
        print(f"distance total : {hud.dist=}")
