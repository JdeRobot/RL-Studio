...
class PPOPendulumTrainer:
    def __init__(self, params):
        ...
        self.ppo_agent = PPO(input_dim, self.num_actions, lr_actor, lr_critic, self.GAMMA, K_epochs, self.epsilon,
                        True, action_std)
        ...
        for episode in tqdm(range(self.RUNS)):
            ...
            if (episode + 1) % self.UPDATE_EVERY == 0:
                ...
                if self.config["save_model"] and last_average > self.max_avg:
                    ...
                    checkpoints_path = "./logs/pendulum/ppo/checkpoints/" + start_time_format + "_actor_avg_" + str(
                        last_average)
