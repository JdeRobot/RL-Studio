...
class LoadEnvVariablesDDPGCarla:
    ...
    def __init__(self, config) -> None:
        ...
        self.environment["gamma"] = config["algorithm"]["ddpg"]["gamma"]
        self.environment["tau"] = config["algorithm"]["ddpg"]["tau"]
        self.environment["std_dev"] = config["algorithm"]["ddpg"]["std_dev"]
        self.environment["replay_memory_size"] = config["algorithm"]["ddpg"][
            "replay_memory_size"
        ]
        self.environment["memory_fraction"] = config["algorithm"]["ddpg"][
            "memory_fraction"
        ]
        self.environment["buffer_capacity"] = config["algorithm"]["ddpg"][
            "buffer_capacity"
        ]
        self.environment["batch_size"] = config["algorithm"]["ddpg"]["batch_size"]
...
class LoadEnvVariablesDQNCarla:
    """
    ONLY FOR DQN algorithm
    Creates a new variable 'environment', which contains Carla env values
    """
    ...
    def __init__(self, config) -> None:
        ...
        self.environment["epsilon_min"] = config["algorithm"]["dqn"]["epsilon_min"]
        self.environment["model_name"] = config["algorithm"]["dqn"]["model_name"]
        self.environment["replay_memory_size"] = config["algorithm"]["dqn"][
            "replay_memory_size"
        ]
        self.environment["min_replay_memory_size"] = config["algorithm"]["dqn"][
            "min_replay_memory_size"
        ]
        self.environment["minibatch_size"] = config["algorithm"]["dqn"][
            "minibatch_size"
        ]
