...
def plot_intensities(ax, folder_path, color, boxplot=False):
    ...
    for file_name in os.listdir(folder_path):
        ...
        if "rewards" in file_name and match and match2 and match3:
            ...
            if extracted_part == 0 and extracted_part2 == 0 and extracted_part3 == 0 \
                    or extracted_part > min_pert_intensity \
                    or extracted_part == min_pert_intensity and extracted_part2 == min_pert_freq:
                ...
                rewards_dict[float(extracted_part) / 10] = rewards
    ...
    if boxplot:
        ...
        ax.boxplot(sorted_rewards, positions=extracted_intensities, widths=0.03,
...
def configure_intensities_graph(ax1, intensities):
...
def configure_boxplot_graph(ax1, intensities):
    ...
    ax1.set_xlim(sorted_intensities[0] - 0.1, sorted_intensities[len(sorted_intensities) - 1] + 0.1)
    xticks = ax1.get_xticklabels()
    for xtick in xticks:
        xtick.set_horizontalalignment('right')
...
if __name__ == "__main__":
    ...
    configure_intensities_graph(ax1, intensities)
    ...
    plt.show()
    base_path = '/home/ruben/Desktop/2020-phd-ruben-lucas/docs/assets/images/results_images/cartpole/solidityExperiments/refinement/refinementOfRefinement/intensity/'
